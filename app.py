...
discussion_page = st.Page("pages/discussion_enjoy.py", title="ディスカッション（1回目）")
survey_page = st.Page("pages/survey_enjoy.py", title="アンケート（1回目）")
discussion2_page = st.Page("pages/discussion_improve.py", title="ディスカッション（2回目）")
survey2_page = st.Page("pages/survey_improve.py", title="アンケート（2回目）")
